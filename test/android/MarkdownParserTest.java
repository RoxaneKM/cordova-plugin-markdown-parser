...
javac MarkdownParserTest.java
java MarkdownParserTest
*/
...
public class MarkdownParserTest {
    ...
    public String parse(String[] rawMarkdown) {

        // Get string text from Array input
        String html = rawMarkdown[0];

        // Declare associative arrays for regular expressions
        LinkedHashMap<String, String> markdownRegexpFind=new LinkedHashMap<String, String>();
        LinkedHashMap<String, String> markdownRegexpReplace = new LinkedHashMap<String, String>();

        // Define 'find' regular expressions and corresponding replacement
    ...
    public static void main(String []args) {
        MarkdownParserTest markdownParser = new MarkdownParserTest();
        String text = "";
        String html = "";
        ...
        // Write html output to html file
        try {

            File file = new File("markdown-preview-output.html");
